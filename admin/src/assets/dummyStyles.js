...
export const dashboardStyles = {
  // Layout styles
  pageContainer: "min-h-screen pt-25 bg-gradient-to-br from-black via-gray-900 to-blue-950 font-serif relative",
  backgroundPattern: "absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.03)_25%,rgba(255,255,255,0.03)_50%,transparent_50%,transparent_75%,rgba(255,255,255,0.03)_75%)] bg-[length:10px_10px] opacity-20 pointer-events-none",
  contentContainer: "relative z-10 container mx-auto px-4 sm:px-6 lg:px-12 py-10",

  // Header styles
  headerContainer: "mb-8 text-center sm:text-left animate-fade-in",
  headerTitle: "text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-2 tracking-tight",
  headerSubtitle: "text-gray-400 text-base sm:text-lg",

  // Stats section
  statsGrid: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-10",
  // Dark card with glow
  statCard: "bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl md:p-3 lg:p-5 xl:p-5 shadow-lg shadow-black/40 p-3 sm:p-6 transform transition-all duration-300 animate-slide-up hover:border-blue-500/30",
  statTitle: "text-gray-400 text-sm sm:text-base font-medium mb-1",
  statValue: "text-2xl sm:text-3xl font-bold text-white",
  statIconContainer: (color) => `${color} p-3 rounded-full text-white shadow-lg shadow-blue-900/20`,
  statIcon: "w-5 h-5 sm:w-6 sm:h-6",

  // Courses section
  coursesContainer: "bg-gray-900/60 backdrop-blur-md border border-gray-700 rounded-2xl shadow-xl overflow-hidden animate-fade-in",
  coursesHeader: "px-4 sm:px-6 py-4 border-b border-gray-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4",
  coursesTitleContainer: "flex items-center",
  coursesIcon: "w-6 h-6 mr-2 text-blue-400",
  coursesTitle: "text-xl sm:text-2xl font-bold text-white",

  // Search bar
  searchContainer: "relative w-full sm:w-auto",
  searchIcon: "w-4 h-4 text-gray-500 absolute left-3 top-1/2 transform -translate-y-1/2",
  searchInput: "pl-10 pr-4 py-2 bg-gray-800 border border-gray-600 text-white rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-64 placeholder-gray-500",

  // Table styles
  tableContainer: "overflow-x-auto",
  table: "min-w-full",
  tableHead: "bg-gray-800/50",
  tableHeader: "px-4 sm:px-6 py-3 sm:py-4 text-left text-sm sm:text-base font-medium text-gray-300",
  tableBody: "divide-y divide-gray-700",
  tableRow: "hover:bg-gray-800/50 transition-colors duration-200 animate-fade-in",

  // Course item styles
  courseImage: "w-10 h-8 sm:w-12 sm:h-10 rounded-lg object-cover mr-3 sm:mr-4 shadow-sm opacity-90",
  courseName: "font-medium px-3 md:px-0 lg:px-0 xl:px-0 text-gray-100 text-sm sm:text-base",
  courseInstructor: "text-xs px-3 md:px-0 lg:px-0 xl:px-0 sm:text-sm text-gray-400",
  studentsCell: "px-9 sm:px-6 py-3 sm:py-4",
  studentsText: "font-medium text-sm sm:text-base text-gray-300",
  priceCell: "px-4 sm:px-6 py-3 sm:py-4 text-white font-semibold text-sm sm:text-base",
  purchasesContainer: "flex items-center text-gray-300",
  purchasesIcon: "w-4 h-4 mr-2 text-green-400",
  purchasesText: "text-sm sm:text-base",
  earningsCell: "px-4 sm:px-6 py-3 sm:py-4 text-green-400 font-semibold text-sm sm:text-base",

  // Empty state
  emptyState: "text-center py-12",
  emptyIcon: "w-12 h-12 text-gray-600 mx-auto mb-4",
  emptyText: "text-gray-400 text-base sm:text-lg",
  clearButton: "mt-2 text-blue-400 hover:text-blue-300 font-medium"
};

// assets/listStyles.js
export const listStyles = {
  // Layout styles
  pageContainer: "min-h-screen bg-gradient-to-br from-black to-blue-950 py-6 sm:py-8 lg:py-10 px-3 sm:px-4 lg:px-6",
  contentContainer: "max-w-6xl pt-20 sm:pt-24 lg:pt-25 font-[pacifico] mx-auto",

  // Header styles
  headerContainer: "text-center mb-6 sm:mb-8",
  headerTitle: "text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-1 tracking-tight",
  headerSubtitle: "text-gray-400 text-sm sm:text-base",

  // Search styles
  searchContainer: "mb-6 sm:mb-8",
  searchInputContainer: "relative max-w-md mx-auto",
  searchIcon: "w-4 h-4 sm:w-5 sm:h-5 text-gray-500 absolute left-3 top-1/2 transform -translate-y-1/2",
  searchInput: "w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 border border-gray-700 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-900/80 text-white shadow-lg shadow-black/20 text-sm sm:text-base placeholder-gray-500",

  // Course list styles
  courseList: "space-y-3 sm:space-y-4",
  courseCard: "bg-gray-900/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-gray-700 overflow-hidden transition-all duration-300 hover:border-blue-500/40 hover:shadow-blue-900/10",
  courseCardContent: "p-4 sm:p-6",

  // Course header styles
  courseHeader: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4",
  courseImageContainer: "flex items-start gap-3 sm:gap-4 flex-1",
  courseImage: "w-16 h-12 sm:w-20 sm:h-16 lg:w-24 lg:h-16 rounded-lg sm:rounded-xl object-cover shadow-md border border-gray-700 flex-shrink-0 opacity-90",
  courseInfo: "flex-1 min-w-0",
  courseTitleRow: "flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-2",
  courseTitle: "text-lg sm:text-xl font-semibold text-white mb-1 break-words group-hover:text-blue-300 transition-colors",
  courseInstructor: "text-gray-400 text-sm sm:text-base mb-2",
  ...
  // Course meta styles
  courseMeta: "flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-400",
  metaItem: "flex items-center gap-1",
  metaIcon: "w-3 h-3 sm:w-4 sm:h-4 text-blue-500",

  // Course actions styles
  courseActions: "flex items-center justify-between lg:justify-end gap-3 sm:gap-4 mt-2 sm:mt-0",
  priceContainer: "text-right",
  priceFree: "text-xl sm:text-2xl font-bold text-green-400",
  priceRegular: "text-xl sm:text-2xl font-bold text-white",
  originalPrice: "text-xs sm:text-sm text-gray-600 line-through",
  actionButtons: "flex items-center gap-1 sm:gap-2",
  toggleButton: "p-1.5 sm:p-2 text-blue-400 hover:text-white hover:bg-blue-600 rounded-full cursor-pointer transition-colors duration-200 flex items-center",
  deleteButton: "p-1.5 sm:p-2 text-gray-500 hover:text-red-400 hover:bg-red-900/30 rounded-lg transition-colors duration-200",
  actionIcon: "w-4 h-4 sm:w-5 sm:h-5",

  // Expanded course details
  expandedCourse: "border-t border-gray-700 bg-gray-800/30 p-4 sm:p-6 animate-fade-in",
  descriptionSection: "mb-4 sm:mb-6",
  descriptionTitle: "text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3",
  descriptionText: "text-gray-400 leading-relaxed text-sm sm:text-base",
  contentSection: "space-y-2 sm:space-y-3",

  // Lecture styles
  lectureCard: "bg-gray-900 rounded-lg border border-gray-700 overflow-hidden",
  lectureHeader: "p-3 sm:p-4 hover:bg-gray-800 transition-colors",
  lectureToggleButton: "flex items-center justify-between w-full text-left gap-2 sm:gap-3",
  lectureInfo: "flex items-center gap-2 sm:gap-3 flex-1 min-w-0",
  lectureTitle: "font-semibold text-gray-200 text-sm sm:text-base break-words",
  lectureMeta: "flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-500 mt-1",
  lectureToggleIcon: (isExpanded) => 
    `w-4 h-4 sm:w-5 sm:h-5 text-blue-400 cursor-pointer transition-transform duration-200 flex-shrink-0 ${
      isExpanded ? 'rotate-180' : ''
  ...
  // Chapter styles
  expandedLecture: "border-t border-gray-700 bg-gray-950/50 p-3 sm:p-4",
  chapterList: "space-y-2 sm:space-y-3",
  chapterCard: "flex items-center justify-between p-2 sm:p-3 bg-gray-800/50 rounded-lg border border-gray-700 hover:border-gray-600 transition-colors",
  chapterContent: "flex-1 min-w-0",
  chapterHeader: "flex items-start gap-2 sm:gap-3",
  chapterIcon: "p-1.5 sm:p-2 bg-blue-900/30 rounded-full shadow-xs flex-shrink-0 mt-0.5",
  chapterIconSvg: "w-3 h-3 sm:w-4 sm:h-4 text-blue-400",
  chapterDetails: "flex-1 min-w-0",
  chapterTitle: "font-medium text-gray-300 text-sm sm:text-base break-words hover:text-blue-300 block transition-colors",
  chapterTopic: "text-xs sm:text-sm text-gray-500 mt-1 break-words",
  chapterMeta: "flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mt-2 text-xs text-gray-600",
  chapterDuration: "flex items-center gap-1",
  chapterVideoLink: "text-blue-500 break-all hover:text-blue-400 hover:underline",

  // Empty state styles
  emptyState: "text-center py-8 sm:py-12",
  emptyIcon: "w-12 h-12 sm:w-16 sm:h-16 text-gray-700 mx-auto mb-3 sm:mb-4",
  emptyText: "text-gray-400 text-base sm:text-lg mb-2",
  clearButton: "text-blue-400 hover:text-blue-300 font-medium text-sm sm:text-base",

  // Star rating styles
  starRating: "flex items-center gap-1",
  starFull: "w-3 h-3 sm:w-4 sm:h-4 text-yellow-500",
  starHalf: "w-3 h-3 sm:w-4 sm:h-4 text-yellow-500",
  starEmpty: "w-3 h-3 sm:w-4 sm:h-4 text-gray-700"
};
...
export const addPageStyles = {
  // Layout styles
  pageContainer: "min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-950 py-4 sm:py-6 lg:py-8 px-3 sm:px-4 lg:px-6",
  contentContainer: "max-w-4xl pt-30 font-serif mx-auto",

  // Header styles
  headerContainer: "text-center mb-8 sm:mb-10 lg:mb-12",
  headerGradient: "relative inline-block",
  headerGlow: "absolute -inset-2 sm:-inset-3 lg:-inset-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl blur-xl opacity-20",
  headerTitle: "relative text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-3 sm:mb-4",
  headerSubtitle: "text-base sm:text-lg lg:text-xl text-gray-400 font-light max-w-2xl mx-auto px-2",

  // Form styles
  form: "space-y-6 sm:space-y-8",

  // Card styles
  card: "bg-gray-900/80 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-700 shadow-xl sm:shadow-2xl hover:border-blue-500/30 transition-colors",
  courseTypeCard: "shadow-black/50",
  courseInfoCard: "shadow-black/50", 
  lecturesCard: "shadow-black/50",

  // Card header styles
  cardHeader: "flex items-center gap-2 sm:gap-3 mb-6 sm:mb-8",
  cardIconContainer: "p-2 sm:p-3 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full shadow-lg shadow-blue-900/40",
  cardIcon: "text-white",
  cardTitle: "text-xl sm:text-2xl font-bold text-white",
  cardSubtitle: "text-sm sm:text-base text-gray-400",
  ...
  courseTypeLabel: (isSelected, type) => 
    `flex items-center gap-2 sm:gap-3 p-3 sm:p-4 border-2 rounded-full cursor-pointer transition-all duration-300 ${
      isSelected
        ? type === 'top' 
          ? "border-orange-600 bg-orange-900/20 shadow-md shadow-orange-900/20"
          : "border-blue-500 bg-blue-900/20 shadow-md shadow-blue-900/20"
        : "border-gray-700 bg-gray-800 hover:border-gray-500"
    }`,
  courseTypeInput: "w-4 h-4 sm:w-5 sm:h-5",
  courseTypeText: "text-base sm:text-lg font-semibold text-gray-200 flex items-center gap-2",
  ...
  // Input styles
  inputContainer: "space-y-2",
  inputLabel: "text-gray-300 font-semibold flex items-center gap-2 text-sm sm:text-base",
  inputIcon: "text-blue-400",
  input: "w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 border-2 border-gray-700 rounded-full text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm text-sm sm:text-base",
  textarea: "w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 border-2 border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm resize-none text-sm sm:text-base",

  // Duration grid
  durationGrid: "grid grid-cols-2 gap-2 sm:gap-3",
  durationHelper: "text-xs text-gray-500 mt-1 block",
  durationFormatted: "text-sm text-blue-400 font-medium",

  // Star rating
  starRating: "flex gap-1",
  starButton: "text-2xl transition-colors duration-200 focus:outline-none hover:scale-110 transform",
  starFull: "text-yellow-400 fill-current",
  starEmpty: "text-gray-700 hover:text-yellow-400",

  // File upload
  uploadContainer: "flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4",
  uploadLabel: "flex-1 w-full cursor-pointer group",
  uploadInput: "hidden",
  uploadBox: "w-full px-3 sm:px-4 py-3 sm:py-4 bg-gray-800/50 border-2 border-dashed border-gray-600 rounded-xl text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 group-hover:border-blue-500 group-hover:bg-gray-800 group-hover:text-blue-400 shadow-inner text-sm sm:text-base",
  uploadIcon: "transition-transform group-hover:scale-110",
  imagePreview: "w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-xl sm:rounded-2xl overflow-hidden border-2 border-gray-600 shadow-lg ring-2 ring-blue-900 flex-shrink-0",

  // Select input
  select: "w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 border-2 border-gray-700 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm appearance-none text-sm sm:text-base",

  // Lectures header
  lecturesHeader: "flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-0 mb-6 sm:mb-8",
  addLectureButton: "bg-gradient-to-r from-blue-600 to-blue-500 cursor-pointer hover:from-blue-500 hover:to-blue-400 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 transform shadow-lg hover:shadow-blue-900/50 text-sm sm:text-base w-full sm:w-auto justify-center",

  // Lectures list
  lecturesList: "space-y-3 sm:space-y-4",
  lectureCard: "bg-gray-800/40 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-700 shadow-lg hover:border-gray-600 transition-all duration-300",
  lectureHeader: "flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4 mb-3 sm:mb-4",
  lectureContent: "flex items-center gap-3 sm:gap-4 flex-1",
  lectureToggleButton: "p-2 bg-blue-900/30 text-blue-400 rounded-full hover:bg-blue-800/50 cursor-pointer transition-colors duration-200 flex-shrink-0 border border-blue-900/50",
  lectureInfo: "flex-1 min-w-0",
  lectureTitle: "text-lg sm:text-xl font-bold text-white break-words",
  lectureMeta: "text-gray-400 flex items-center gap-2 mt-1 text-sm sm:text-base",
  lectureActions: "flex items-center gap-2 justify-end sm:justify-start",
  addChapterButton: "bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-medium transition-all duration-300 flex items-center gap-2 cursor-pointer shadow-md text-xs sm:text-sm",
  deleteButton: "p-1.5 sm:p-2 text-red-400 hover:text-red-300 cursor-pointer hover:bg-red-900/30 rounded-full transition-colors duration-200 ml-1 sm:ml-2",

  // Chapters list
  chaptersContainer: (isExpanded) => 
    `ml-0 sm:ml-10 lg:ml-12 space-y-2 sm:space-y-3 border-l-0 sm:border-l-2 border-purple-900/50 pl-0 sm:pl-4 lg:pl-6 mt-3 sm:mt-0 ${
      isExpanded ? 'block' : 'hidden'
    }`,
  chapterCard: "bg-gray-900 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-700 shadow-sm hover:border-gray-600",
  chapterContent: "flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-0",
  chapterInfo: "flex-1 min-w-0",
  chapterTitle: "text-gray-200 font-semibold text-sm sm:text-base break-words",
  chapterTopic: "text-gray-500 text-xs sm:text-sm mt-1 break-words",
  chapterMeta: "flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 mt-2",
  chapterDuration: "text-purple-400 text-xs sm:text-sm flex items-center gap-1 font-medium",
  chapterUrl: "text-blue-400 text-xs sm:text-sm font-medium break-all max-w-full sm:max-w-xs hover:underline",
  chapterDeleteButton: "p-1 text-red-400 hover:text-red-300 cursor-pointer hover:bg-red-900/30 rounded-full transition-colors duration-200 ml-0 sm:ml-4 self-end sm:self-auto mt-2 sm:mt-0",

  // Submit button
  submitContainer: "text-center",
  submitButton: "bg-gradient-to-r from-blue-600 to-purple-600 cursor-pointer text-white px-8 sm:px-12 lg:px-16 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg transition-all duration-300 transform shadow-lg hover:shadow-blue-900/50 relative overflow-hidden group w-full sm:w-auto border border-transparent",

  // Modal styles
  modalOverlay: "fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 z-50",
  modal: "bg-gray-900 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 max-w-md w-full border border-gray-700 shadow-2xl mx-2",
  modalHeader: "flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6",
  modalIconContainer: (color) => `p-2 ${color} rounded-full shadow-lg`,
  modalTitle: "text-xl sm:text-2xl font-bold text-white",
  modalContent: "space-y-3 sm:space-y-4",
  modalActions: "flex gap-2 sm:gap-3 pt-3 sm:pt-4",
  modalButton: "flex-1 py-2 sm:py-3 rounded-full font-semibold transition-all duration-300 flex items-center justify-center gap-2 shadow-lg text-sm sm:text-base",
  modalButtonPrimary: "bg-gradient-to-r from-blue-600 to-purple-600 cursor-pointer text-white hover:from-blue-500 hover:to-purple-500",
  modalButtonSecondary: "bg-gray-700 text-gray-200 hover:bg-gray-600 cursor-pointer border border-gray-600",
  modalButtonCompact: "flex-1 py-2 sm:py-3 rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base",
  modalButtonCompactPrimary: "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white shadow-lg hover:scale-105 cursor-pointer",
  modalButtonCompactSecondary: "bg-gray-700 hover:bg-gray-600 text-gray-200 cursor-pointer border border-gray-600",

  // Chapters list in modal
  chaptersList: "space-y-2 max-h-24 sm:max-h-32 overflow-y-auto custom-scrollbar",
  chapterPreview: "bg-gray-800 rounded-lg p-2 sm:p-3 text-xs sm:text-sm border border-gray-700",
  chapterPreviewTitle: "font-medium text-gray-200",
  chapterPreviewDuration: "text-blue-400 text-xs"
};
...
export const navbarStyles = {
  ...
  navContainer: "w-full flex justify-center",
  navInner: (isMenuOpen) => 
    `relative w-[90%] rounded-xl xl:rounded-full md:rounded-full sm:w-[90%] md:w-[95%] lg:w-[70%] xl:w-[90%] max-w-6xl mx-auto lg:rounded-full px-4 py-1 md:py-3 lg:py-3 xl:py-3 sm:py-3 backdrop-blur-md bg-gray-900/70 border border-gray-700/50 shadow-xl shadow-black/50 transition-all duration-500`,

  // Glow effect
  glowEffect: "pointer-events-none absolute -inset-1 rounded-3xl blur-[18px] opacity-20 bg-gradient-to-r from-blue-600 to-purple-600 mix-blend-screen",
  ...
  logoContainer: "flex items-center gap-3 select-none",
  logoImage: "w-12 h-12 object-contain",
  logoText: "text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400",

  // Desktop navigation
  desktopNav: "hidden md:flex items-center justify-center flex-1",
  desktopNavInner: "inline-flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-full p-1 shadow-inner border border-white/5",
  desktopNavItem: (isActive) => 
    `relative flex items-center gap-2 cursor-pointer px-4 py-2 rounded-full font-medium transition-all duration-300 transform group overflow-hidden ${
      isActive
  ...
  desktopNavIcon: "w-4 h-4",
  desktopNavText: "text-sm",
  desktopActiveGlow: "absolute -inset-px rounded-full pointer-events-none blur-sm opacity-60 bg-gradient-to-r from-blue-500 to-purple-500 mix-blend-screen",

  // Mobile menu toggle
  mobileToggleContainer: "flex items-center gap-3 md:hidden",
  mobileToggleButton: "w-10 h-10 rounded-xl bg-gray-800/60 backdrop-blur-sm border border-gray-700 flex items-center justify-center shadow-sm hover:border-gray-500 text-gray-300",
  mobileToggleIcon: "w-5 h-5",
  ...
  mobileMenuInner: "flex flex-col gap-2 bg-gray-900/90 rounded-xl p-2 border border-gray-700 shadow-2xl",
  mobileMenuItem: (isActive) => 
    `w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 ${
      isActive
...
export const bookingsStyles = {
  // Layout styles
  pageContainer: "min-h-screen pt-35 bg-gradient-to-br from-black to-blue-950 font-serif p-6",
  contentContainer: "max-w-6xl mx-auto",
  ...
  searchContainer: "p-4 mb-8",
  searchInputContainer: "relative max-w-md",
  searchIcon: "absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 h-5 w-5",
  searchInput: "w-full pl-10 pr-4 py-2 border border-gray-700 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-900 text-white placeholder-gray-500",

  // Bookings grid
  bookingsGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6",

  // Booking card
  bookingCard: "bg-gray-900/80 rounded-xl shadow-lg border border-gray-700 p-6 hover:shadow-blue-900/20 hover:border-blue-500/30 transition backdrop-blur-sm",

  // Student section
  studentSection: "flex items-center mb-4",
  studentIconContainer: "bg-blue-900/30 p-2 rounded-full",
  studentIcon: "h-6 w-6 text-blue-400",
  studentInfo: "ml-3 overflow-hidden",
  studentName: "font-semibold text-white text-lg truncate",
  purchaseDate: "text-sm text-gray-400",

  // Course details
  courseDetails: "space-y-3",
  detailItem: "flex items-center",
  detailIcon: "h-4 w-4 text-blue-500 mr-2 flex-shrink-0",
  detailLabel: "text-gray-400 font-medium",
  detailValue: "ml-2 text-gray-200 truncate",
  priceValue: "ml-2 text-green-400 font-semibold",

  // Status
  statusContainer: "mt-4 pt-4 border-t border-gray-700",
  statusBadge: "inline-flex px-3 py-1 rounded-full text-sm font-medium bg-green-900/30 text-green-400 border border-green-800/50",

  // Empty state
  emptyState: "text-center py-12",
  emptyContainer: "bg-gray-900/50 rounded-lg p-8 max-w-md mx-auto border border-gray-700",
  emptyIcon: "h-12 w-12 text-gray-600 mx-auto mb-4",
  emptyTitle: "text-lg font-semibold text-white mb-2",
