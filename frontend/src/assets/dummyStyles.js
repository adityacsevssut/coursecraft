...
export const bannerStyles = {
  ...
  // Floating icon base styles
  floatingIcon: "absolute animate-float max-w-none pb-4 md:-ml-11.5 md:mt-2 lg:-mr-12 lg:-ml-13 xl:-mr-0 xl:-ml-0 xl:mt-5 xl:w-12 xl:h-40 md:-mr-12 lg:-mr-0 xl:-mr-0 pointer-events-none drop-shadow-xl glow-icon transform transition-transform duration-300 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 opacity-50",
  ...
  videoModal: {
    ...
    container: "relative w-[90%] max-w-3xl aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10",
    iframe: "w-full h-full",
    closeButton: "absolute top-3 cursor-pointer right-3 bg-gray-800/90 hover:bg-gray-700 text-white font-bold rounded-full p-2 shadow-lg transition-all duration-200",
    closeIcon: "w-5 h-5"
  },
  ...
  featuresGrid: "grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 animate-fade-in opacity-0 animation-delay-700",
  featureItem: "flex items-center space-x-3",
  featureIconContainer: "w-6 h-6 flex items-center justify-center shrink-0 text-blue-400",
  featureIcon: "text-sm",
  featureText: "text-gray-300 font-serif text-sm sm:text-base not-italic",
  ...
  // Image
  imageContainer: "flex items-center justify-center",
  image: "w-full max-w-[220px] sm:max-w-sm md:max-w-md lg:max-w-sm h-auto rounded-2xl shadow-2xl border border-white/10 animate-float opacity-90"
};
...
// Custom CSS styles as string (for the style jsx block) (Unchanged)
export const customStyles = `
  @import url("https://fonts.googleapis.com/css2?family=Dancing+Script:wght@600&display=swap");
...
// src/assets/dummyStyles.js
export const aboutUsStyles = {
  // Layout & Container - Dark gradient background
  container: "min-h-screen bg-gradient-to-br from-gray-950 via-black to-indigo-950",
  
  // Hero Section
  heroSection: "relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden",
  heroBackground: "absolute inset-0 z-0",
  heroImageContainer: "absolute inset-0 bg-cover bg-center transform scale-105 opacity-40", // Reduced opacity
  heroVignette: "absolute inset-0 pointer-events-none bg-gradient-to-t from-black via-black/50 to-transparent", // Dark vignette
  heroTint: "absolute inset-0 bg-slate-900/60 mix-blend-multiply pointer-events-none",
  heroContent: "relative z-20 max-w-7xl mx-auto text-center",
  
  // Trust Badge
  trustBadge: "inline-flex items-center px-6 py-3 rounded-full bg-white/5 text-white text-lg mb-8 backdrop-blur-sm border border-white/10 shadow-sm",
  trustIcon: "w-5 h-5 mr-2 fill-current text-blue-400",
  
  // Typography
  mainHeading: "text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 font-serif tracking-tight drop-shadow-lg",
  subHeading: "text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8 drop-shadow",
  inlineHighlight: "inline-block ml-2 px-2 py-1 text-blue-300 bg-blue-900/30 rounded-full font-semibold",
  
  // Stats
  statsGrid: "grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto",
  statCard: "text-center p-4 bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-white/10",
  statNumber: "text-2xl font-bold text-white drop-shadow-sm",
  ...
  sectionContentGrid: "grid lg:grid-cols-2 md:grid-cols-2 gap-16 items-center",
  sectionImageContainer: "relative",
  sectionImage: "relative group opacity-90",
  sectionContent: "",
  sectionBadge: "inline-flex items-center px-4 py-2 rounded-full bg-white-800 shadow-lg mb-6 border border-gray-700",
  sectionIcon: "w-5 h-5 mr-2 text-gradient bg-gradient-to-r from-blue-400 to-purple-400",
  sectionBadgeText: "font-semibold text-black-200",
  sectionTitle: "text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl font-bold text-black mb-6 font-serif",
  sectionDescription: "text-xl text-black-400 mb-8 leading-relaxed",
  featuresContainer: "space-y-4 mb-8",
  featureItem: "flex items-center gap-4 group",
  featureIcon: "w-8 h-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0 transition-transform",
  featureIconSvg: "w-5 h-5 text-white",
  featureText: "text-lg text-black-300 font-medium",
  
  // Values Section - Dark theme
  valuesSection: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-black to-gray-900",
  valuesHeader: "text-center mb-16",
  valuesBadge: "inline-flex items-center px-6 py-3 rounded-full bg-gray-800 shadow-lg mb-6 border border-gray-700",
  valuesBadgeIcon: "w-6 h-6 text-blue-400 mr-2",
  valuesBadgeText: "font-semibold text-gray-200",
  valuesTitle: "text-2xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl font-bold text-white mb-4 font-serif",
  valuesSubtitle: "text-xl text-gray-400 max-w-2xl mx-auto",
  valuesGrid: "grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8",
  valueCard: "bg-gray-800/50 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group border border-gray-700 relative overflow-hidden",
  valueGradient: "absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 opacity-0 group-hover:opacity-20 transition-opacity duration-500",
  valueCardTitle: "text-2xl font-bold font-[pacifico] text-white mb-4 relative z-10 truncate",
  valueCardDescription: "text-gray-400 leading-relaxed mb-6 relative z-10",
  valueFeatures: "space-y-3 relative z-10",
  valueFeatureItem: "flex items-center gap-3 text-gray-300",
  valueFeatureDot: "w-2 h-2 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full",
  valueUnderline: "absolute bottom-0 left-0 w-0 group-hover:w-full h-1 bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-500",
  
  // Team Section - Dark theme
  teamSection: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 to-blue-950",
  teamHeader: "text-center mb-16",
  teamTitle: "text-2xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl font-bold text-white mb-4 font-serif",
  teamSubtitle: "text-xl text-gray-400 max-w-2xl mx-auto",
  teamGrid: "grid md:grid-cols-2 lg:grid-cols-4 gap-8",
  teamMember: "text-center font-[pacifico] group cursor-pointer",
  teamImageContainer: "relative mb-6",
  teamImage: "w-48 h-48 mx-auto rounded-full transform transition-all duration-500 border-4 border-gray-800 group-hover:border-blue-500",
  teamName: "text-2xl font-bold text-white mb-2 transition-colors",
  teamRole: "text-blue-400 italic font-semibold mb-2",
  teamBio: "text-gray-400 mb-4",
  
  // Testimonials Section - Dark theme
  testimonialsSection: "py-20 px-4 sm:px-6 lg:px-8 bg-black",
  testimonialsHeader: "text-center mb-16",
  testimonialsTitle: "text-2xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl font-bold text-white mb-4 font-serif",
  testimonialsSubtitle: "text-xl text-gray-400 max-w-2xl mx-auto",
  testimonialsGrid: "grid md:grid-cols-3 gap-8",
  testimonialCard: "bg-gray-800 p-8 rounded-3xl hover:shadow-xl transition-all duration-300 group border border-gray-700",
  testimonialStars: "flex items-center gap-2 mb-4",
  testimonialStar: "w-5 h-5 text-yellow-500 fill-current",
  testimonialText: "text-gray-300 mb-6 leading-relaxed italic",
  testimonialAuthor: "flex items-center gap-4",
  testimonialAvatar: "w-12 h-12 rounded-full object-cover border-2 border-gray-700",
  testimonialAuthorName: "font-semibold text-white",
  testimonialAuthorRole: "text-gray-400 text-sm",
  
  // CTA Section - Darker gradient
  ctaSection: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 relative overflow-hidden",
  ...
  ctaContent: "relative max-w-4xl mx-auto text-center",
  ctaTitle: "text-5xl md:text-6xl font-bold text-white mb-6 font-serif",
  ctaDescription: "text-xl text-blue-200 mb-12 max-w-2xl mx-auto leading-relaxed",
  ctaButtons: "flex flex-col sm:flex-row gap-6 justify-center items-center mb-8",
  ctaButton: "group bg-transparent cursor-pointer border-2 border-white/80 text-white px-12 py-5 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all duration-300 flex items-center gap-3 backdrop-blur-sm hover:shadow-2xl hover:border-white",
  ctaButtonIcon: "w-5 h-5 group-hover:scale-110 transition-transform"
};

// CSS animations (for style jsx) (Unchanged)
export const aboutUsAnimations = `
  @keyframes float {
    0%, 100% {
      transform: translateY(0px) rotate(0deg);
...
// Add these to the existing dummyStyles.js file
export const contactStyles = {
  // Layout & Container - Dark background
  container: "min-h-screen bg-gradient-to-br from-black to-gray-900 py-10 px-4 sm:px-6 md:px-10 lg:px-12 overflow-x-hidden",
  mainContainer: "max-w-7xl mx-auto",
  
  // Header
  header: "text-center mb-12 sm:mb-16",
  title: "text-3xl sm:text-4xl md:text-5xl inline-flex items-center space-x-2 mt-15 rounded-full px-4 sm:px-6 py-2 sm:py-3 border border-purple-900/50 font-bold bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent font-['Poppins'] bg-gray-800/50",
  ...
  // Contact Form
  formContainer: "relative order-2 lg:order-1",
  formGlow1: "absolute -inset-1 bg-gradient-to-r from-purple-600/30 to-blue-600/30 rounded-2xl opacity-75 blur-sm animate-pulse",
  formGlow2: "absolute -inset-1 bg-gradient-to-r from-purple-600/30 to-blue-600/30 rounded-2xl opacity-50 animate-pulse delay-75",
  formGlow3: "absolute -inset-1 bg-gradient-to-r from-purple-600/30 to-blue-600/30 rounded-2xl opacity-25 animate-pulse delay-150",
  form: "relative bg-gray-800/90 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-700 backdrop-blur-sm",
  formElements: "space-y-6",
  ...
  // Form Groups
  formGroup: "group",
  label: "block text-sm font-medium text-gray-300 mb-2 flex items-center",
  labelIcon: "w-4 h-4 mr-2 text-gray-400",
  input: "w-full px-4 py-3 rounded-lg border border-gray-600 focus:ring-2 focus:border-transparent transition-all duration-300 bg-gray-700/50 text-white placeholder-gray-500 focus:bg-gray-700",
  inputError: "border-red-500",
  errorText: "mt-2 text-sm text-red-400",
  textarea: "w-full px-4 py-3 rounded-lg border border-gray-600 focus:ring-2 focus:border-transparent transition-all duration-300 bg-gray-700/50 text-white placeholder-gray-500 focus:bg-gray-700 group-hover:border-blue-500 resize-none",
  select: "w-full px-4 py-3 rounded-lg border border-gray-600 focus:ring-2 focus:border-transparent transition-all duration-300 bg-gray-700/50 text-white focus:bg-gray-700 group-hover:border-purple-500",
  
  // Colors for different form fields (Adjusted for dark mode pop)
  colors: {
    purple: {
  ...
  // Submit Button
  submitButton: "w-full py-4 px-6 rounded-full font-bold text-white transition-all duration-300 flex items-center justify-center",
  submitButtonEnabled: "bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 shadow-lg hover:shadow-xl hover:shadow-green-900/30",
  submitButtonDisabled: "bg-gray-600 cursor-not-allowed text-gray-300",
  spinner: "w-5 h-5 border-t-2 border-white rounded-full animate-spin mr-2",
  submitIcon: "w-5 h-5 mr-2",
  
  // Animation Section
  animationContainer: "relative order-1 xl:order-2 lg:order-2 w-full flex justify-center items-center",
  animationWrapper: "relative max-w-md sm:max-w-lg md:max-w-xl lg:max-w-full xl:max-w-full rounded-2xl overflow-hidden opacity-90",
  
  // Footer Info
  footer: "mt-12 sm:mt-16 text-center",
  footerBadge: "inline-flex items-center space-x-2 bg-gray-800/50 rounded-full px-4 sm:px-6 py-2 sm:py-3 border border-gray-700",
  footerIcon: "w-5 h-5 text-purple-400",
  footerText: "text-gray-300 text-sm sm:text-base"
};

// Add these to your existing assets/dummyStyles.js

export const coursePageStyles = {
  // Layout and container styles - Dark theme
  pageContainer: "min-h-screen pt-24 md:pt-24 bg-gradient-to-br from-black via-gray-900 to-blue-950 py-8 px-4 relative overflow-hidden",
  headerContainer: "text-center mb-12 md:mb-16 relative z-10",
  headerTransform: "transform perspective-1000 mb-6",
  headerTitle: "text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black mb-4 md:mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-500 tracking-tight font-[pacifico]",
  headerSubtitle: "text-base sm:text-lg md:text-2xl text-gray-300 font-light mb-6 md:mb-8 tracking-wide",
  
  // Search bar
  searchContainer: "max-w-2xl mx-auto mb-8 md:mb-12 relative group px-2 sm:px-0",
  searchGradient: "absolute -inset-1 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 rounded-3xl blur-lg opacity-30 group-hover:opacity-70 transition-opacity duration-700 animate-gradient-x",
  searchInputContainer: "relative bg-gray-900/80 backdrop-blur-lg border border-gray-700 group-hover:border-blue-500 rounded-3xl shadow-xl transition-all duration-500",
  searchIconContainer: "absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none",
  searchIcon: "w-5 h-5 text-blue-400 group-hover:text-indigo-400 transition-colors duration-500",
  searchInput: "w-full pl-12 pr-10 py-3 rounded-3xl bg-transparent text-white placeholder-gray-400 focus:outline-none focus:ring-0 font-medium text-sm sm:text-base",
  clearButton: "absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center text-gray-400 hover:text-red-400 transition-colors duration-300",
  
  // Results count
  resultsCount: "text-gray-400 text-sm sm:text-base",
  
  // No courses found
  noCoursesContainer: "text-center py-12",
  noCoursesIcon: "w-16 h-16 mx-auto text-gray-600",
  noCoursesTitle: "text-xl font-semibold text-gray-300 mb-2",
  noCoursesButton: "mt-4 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors w-full sm:w-auto shadow-lg",
  ...
  courseCard: "group perspective-1000 transform-style-3d transition-all duration-500 ease-out cursor-pointer",
  courseCardInner: "relative transform-style-3d group-hover:rotate-y-5 group-hover:rotate-x-5 transition-transform duration-500 ease-out h-full",
  courseCardContent: "backdrop-blur-lg rounded-3xl shadow-xl border border-gray-700/50 transform translate-z-0 h-full flex flex-col bg-gray-800/90 overflow-hidden hover:border-blue-500/50",
  
  // Course image
  courseImageContainer: "relative overflow-hidden rounded-t-3xl h-48 pb-6 sm:h-44 md:h-48",
  courseImage: "w-full h-full object-cover object-center transform transition-transform duration-700 opacity-90 group-hover:opacity-100",
  
  // Course info
  courseInfo: "p-4 sm:p-6 flex-1 flex flex-col",
  courseName: "text-base sm:text-lg font-bold text-white leading-tight line-clamp-2 mb-2",
  teacherContainer: "flex items-center space-x-2 mb-3 text-sm sm:text-sm",
  teacherIcon: "w-4 h-4 text-blue-400",
  teacherName: "text-gray-300 font-medium truncate",
  ...
  // Price
  priceContainer: "mt-auto flex items-center justify-between",
  priceFree: "text-2xl font-bold text-green-400",
  priceCurrent: "text-2xl font-bold text-green-400",
  priceOriginal: "text-lg text-gray-500 line-through",
  
  // Show more button
  showMoreContainer: "mt-8 flex justify-center px-2 sm:px-0",
  showMoreButton: "px-5 py-3 rounded-full cursor-pointer bg-gray-800/80 backdrop-blur-sm border border-gray-700 shadow hover:shadow-md hover:bg-gray-700 transition-all duration-300 flex items-center space-x-3 w-full sm:w-auto justify-center",
  showMoreText: "text-sm font-medium text-white"
};
...
export const myCoursesStyles = {
  // Layout and container styles - Dark theme
  pageContainer: "min-h-screen bg-gradient-to-br from-black to-blue-950 py-8 font-[pacifico]",
  mainContainer: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
  
  // Header
  header: "text-4xl font-bold text-white mb-12 text-center",
  emptyHeader: "text-4xl font-bold text-white mb-6",
  ...
  courseCard: "group bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-700 cursor-pointer hover:border-blue-500/30",
  imageContainer: "relative overflow-hidden",
  courseImage: "w-full h-48 object-contain pb-7.5 lg:pb-6 xl:pb-8.5 transition-transform duration-700 opacity-90",
  courseContent: "p-5",
  
  // Course info
  courseName: "text-lg font-bold text-white mb-3 line-clamp-2 transition-colors duration-300 group-hover:text-blue-300",
  infoContainer: "flex items-center justify-between mb-4",
  
  // Rating
  ratingContainer: "flex items-center space-x-1 bg-yellow-900/30 rounded-full px-3 py-1 border border-yellow-700/50",
  ratingIcon: "w-4 h-4 text-yellow-500 fill-current",
  ratingText: "text-sm font-semibold text-yellow-200",
  
  // Teacher
  teacherContainer: "flex items-center space-x-1 bg-blue-900/30 rounded-full px-3 py-1 border border-blue-700/50",
  teacherIcon: "w-4 h-4 text-blue-400",
  teacherText: "text-sm font-medium text-blue-200 truncate max-w-[80px]",
  
  // Button
  viewButton: "w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold py-3 px-4 rounded-full transition-all duration-300 transform shadow-lg hover:shadow-blue-900/50 flex items-center justify-center space-x-2 cursor-pointer group/btn border border-transparent",
  buttonIcon: "w-4 h-4 transition-transform duration-300 group-hover/btn:scale-110",
  buttonText: ""
};

// Custom styles for MyCourses (Unchanged)
export const myCoursesCustomStyles = `
  @keyframes fadeInUp {
    from {
      opacity: 0;
...
// Custom styles for CoursePage (Unchanged)
export const coursePageCustomStyles = `
  .perspective-1000 { perspective: 1000px; }
  .transform-style-3d { transform-style: preserve-3d; }
  .translate-z-0 { transform: translateZ(0px); }
...
export const footerStyles = {
  // Layout and container styles - Dark theme
  footer: "relative bg-gradient-to-br from-gray-950 via-black to-blue-950 text-slate-200 overflow-hidden border-t border-gray-800",
  container: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16",
  ...
  brandTransform: "transform transition-transform duration-500",
  brandContainer: "relative mb-4 sm:mb-6 group",
  brandGradient: "absolute -inset-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-2xl blur-lg opacity-20 sm:opacity-30 transition-all duration-500 pointer-events-none",
  brandTitle: "text-2xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 py-1",
  brandDescription: "text-slate-400 leading-relaxed mb-4 text-sm sm:text-sm",
  
  // Section headers
  sectionHeader: "text-lg font-semibold mb-4 text-white flex items-center gap-2",
  sectionIcon: "w-5 h-5 text-blue-400",
  
  // Links
  linksList: "space-y-2",
  linkItem: "text-slate-400 transition-all duration-300 transform hover:translate-x-2 flex items-center gap-3 p-2 rounded-lg hover:bg-gray-800/50 hover:text-white min-w-0",
  linkIcon: "w-4 h-4 flex-shrink-0 text-slate-500 group-hover:text-blue-400",
  
  // Contact info
  contactSpace: "space-y-3 text-slate-400",
  contactItem: "flex items-center group transform transition-all duration-300 p-3 rounded-xl hover:bg-gray-800/50",
  contactIconContainer: "flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mr-3 sm:mr-4 transform transition-transform duration-300 shadow-lg border border-gray-700 overflow-hidden bg-gray-900",
  contactIcon: "w-4 h-4",
  contactTextContainer: "min-w-0",
  contactTextPrimary: "font-medium text-sm break-words text-white",
  contactTextSecondary: "text-xs text-slate-500 group-hover:text-slate-400",
  
  // Social section
  socialSection: "border-t border-gray-800 pt-8",
  socialContainer: "flex flex-col lg:flex-row items-center justify-between gap-6",
  socialIconsContainer: "flex flex-wrap items-center gap-3 sm:gap-4 justify-center lg:justify-start",
  socialIconLink: "relative group transform transition-all duration-300 hover:scale-105",
  socialIconContainer: "relative w-10 h-10 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center border border-gray-700/80 shadow-md backdrop-blur-sm overflow-hidden bg-gray-900 hover:border-blue-500/50",
  socialIconInner: "absolute inset-0 flex items-center justify-center transition-transform duration-300 group-hover:scale-110",
  socialIcon: "w-5 h-5 sm:w-6 sm:h-6 text-slate-300 group-hover:text-white",
  socialTooltip: "absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none hidden md:block",
  socialTooltipArrow: "absolute -top-1 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-gray-700 rotate-45",
  
  // Design credit
  designCredit: "text-center lg:text-right",
  designCreditContainer: "relative inline-block group",
  designCreditGradient: "absolute -inset-1 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl blur-lg opacity-20 group-hover:opacity-40 transition-all duration-500 pointer-events-none",
  designCreditText: "relative font-[pacifico] text-slate-400 text-sm bg-gray-900/80 backdrop-blur-sm rounded-lg px-4 sm:px-6 py-3 border border-gray-700/80 shadow-sm inline-flex items-center gap-2 group-hover:text-white",
  designCreditLink: "ml-1 font-medium text-slate-300 hover:text-purple-400 transition-colors duration-300"
};

// Background elements styles - Adjusted for subtler dark mode
export const footerBackgroundStyles = {
  backgroundContainer: "absolute inset-0 pointer-events-none",
  floatingOrb1: "hidden sm:block absolute top-10 left-10 w-24 h-24 bg-gradient-to-r from-cyan-900/20 to-blue-900/20 rounded-full blur-xl animate-float-1 opacity-30",
  floatingOrb2: "hidden sm:block absolute top-32 right-20 w-32 h-32 bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-full blur-xl animate-float-2 opacity-30",
  floatingOrb3: "hidden sm:block absolute bottom-20 left-1/4 w-28 h-28 bg-gradient-to-r from-emerald-900/20 to-teal-900/20 rounded-full blur-xl animate-float-3 opacity-30",
  floatingOrb4: "hidden sm:block absolute bottom-32 right-32 w-20 h-20 bg-gradient-to-r from-amber-900/20 to-orange-900/20 rounded-full blur-xl animate-float-4 opacity-30",
  gridOverlay: "absolute inset-0 opacity-[0.05] pointer-events-none bg-[url('/grid-pattern.svg')]" // Assuming a grid pattern svg exists, or remove if not.
};

// Contact icon background gradients - Darker
export const contactIconGradients = {
  address: "bg-gradient-to-br from-cyan-900 to-blue-900",
  phone: "bg-gradient-to-br from-purple-900 to-pink-900", 
  email: "bg-gradient-to-br from-emerald-900 to-teal-900"
};
...
export const iconColors = {
  ...
  cyan600: "text-cyan-400",
  purple600: "text-purple-400",
  emerald600: "text-emerald-400"
};

// Custom styles for Footer (Unchanged)
export const footerCustomStyles = `
  @keyframes float-1 {
    0%, 100% { transform: translateY(0px) rotate(0deg) scale(1); }
    33% { transform: translateY(-12px) rotate(3deg) scale(1.03); }
...
export const homeCoursesStyles = {
  ...
  container: "bg-gradient-to-b from-black to-gray-900 min-h-screen py-10 sm:py-14 px-4 sm:px-6 lg:px-12",
  mainContainer: "max-w-7xl mx-auto",
  
  // Header Section
  header: "flex flex-col items-center gap-6",
  title: "text-3xl sm:text-4xl md:text-4xl mb-0 text-center bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text drop-shadow-lg flex items-center justify-center gap-3",
  titleIcon: "w-7 h-7 md:w-8 md:h-8 animate-spin-slow text-blue-400",
  ...
  courseCard: "cursor-pointer group",
  imageContainer: "relative rounded-2xl xl:rounded-2xl overflow-hidden",
  courseImage: "w-full object-cover transition-transform duration-300 group-hover:shadow-[0_8px_32px_0_rgba(59,130,246,0.3)] h-48 lg:w- sm:h-48 md:h-40 lg:h-48 opacity-90 group-hover:opacity-100",
  
  // Course Info - Dark theme
  courseInfo: "mt-4 px-3 bg-gray-800/90 backdrop-blur-md rounded-xl -translate-y-3 sm:-translate-y-5 shadow-xl space-y-2 py-3 border border-gray-700 group-hover:border-blue-500/50",
  courseName: "text-base sm:text-lg text-white flex items-center truncate group-hover:text-blue-300",
  teacherInfo: "flex items-center text-gray-400 text-sm",
  teacherIcon: "mr-1 text-pink-400",
  teacherName: "italic text-purple-300 truncate",
  
  // Rating Section
  ratingContainer: "flex items-center mt-1",
  starsContainer: "flex items-center gap-2 bg-gray-900/50 px-2 py-0.5 rounded-full",
  interactiveStars: "flex",
  starButton: "p-1 sm:p-0.5 focus:outline-none transform transition-transform active:scale-95",
  starButtonActive: "text-yellow-400",
  ...
  // Pricing Section
  pricingContainer: "flex items-center mt-2 space-x-2",
  freePrice: "text-lg sm:text-xl font-bold text-green-400 drop-shadow",
  salePrice: "text-lg sm:text-xl font-bold text-green-400 drop-shadow",
  originalPrice: "line-through text-gray-500 font-medium",
  
  // CTA Button
  ctaContainer: "flex justify-center mt-12",
  ctaWrapper: "relative inline-block group",
  ctaGlow: "absolute -inset-1 rounded-full border-0 pointer-events-none border-anim bg-gradient-to-r from-blue-600 to-purple-600 blur opacity-50",
  ctaButton: "relative z-10 inline-flex items-center gap-4 px-12 py-4 text-xl font-bold rounded-3xl bg-gray-900/50 backdrop-blur-md text-white shadow-2xl transform transition duration-300 cursor-pointer active:scale-95 focus:outline-none border border-blue-500/50 hover:bg-blue-900/30",
  ctaButtonContent: "relative flex items-center gap-3",
  ctaText: "relative z-10",
  ctaIcon: "w-5 h-5 z-10 transition-transform duration-300 group-hover:translate-x-2 text-blue-400",
  
  // Font Classes (Unchanged)
  fonts: {
    title: "font-[Montserrat] font-bold tracking-wider",
    course: "font-[Poppins] font-semibold tracking-wide",
    detail: "font-[Poppins]"
...
export const navbarStyles = {
  ...
  navbarVisible: "translate-y-0 opacity-100",
  navbarHidden: "-translate-y-full opacity-0",
  navbarScrolled: "bg-black/90 backdrop-blur-xl shadow-sm py-2 border-b border-gray-800",
  navbarDefault: "bg-gradient-to-br from-black via-gray-900 to-blue-950 py-3 border-b border-gray-800",
  ...
  desktopNavItemActive: "bg-blue-600 text-white shadow-md shadow-blue-900/30",
  desktopNavIcon: "text-gray-400 transition-colors duration-300 group-hover:text-blue-400",
  ...
  logoutButton: "hidden lg:flex items-center space-x-2 px-4 py-2 rounded-xl bg-transparent text-white text-sm font-semibold shadow-sm hover:shadow-md transform transition-all duration-300 group border border-gray-600 hover:bg-gray-800",
  
  // Mobile Menu Button
  mobileMenuButton: "lg:hidden p-2 rounded-xl bg-gray-900 shadow-sm border border-gray-800 text-gray-300 hover:text-blue-400 hover:border-blue-500 transition-all duration-300",
  
  // Mobile Menu - Dark theme
  mobileMenu: "lg:hidden transition-all duration-500 overflow-hidden",
  mobileMenuOpen: "max-h-[500px] opacity-100 mt-3",
  mobileMenuClosed: "max-h-0 opacity-0",
  mobileMenuContainer: "bg-gray-900/95 backdrop-blur-xl rounded-2xl p-4 shadow-xl border border-gray-800",
  mobileMenuItems: "space-y-2",
  mobileMenuItem: "flex items-center space-x-3 p-3 rounded-xl transition-all duration-300 hover:bg-gray-800",
  mobileMenuItemActive: "bg-blue-900/30 border border-blue-800/50",
  mobileMenuItemHover: "hover:bg-gray-800",
  mobileMenuIconContainer: "p-2 rounded-lg bg-gray-800 transition-colors duration-300 group-hover:bg-blue-900/30",
  mobileMenuIcon: "text-blue-400",
  mobileMenuText: "font-medium text-gray-200",
  
  // Mobile Auth Buttons
  mobileLoginButton: "w-full flex items-center justify-center space-x-2 p-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 mt-2",
  mobileLogoutButton: "w-full flex items-center justify-center space-x-2 p-3 rounded-xl bg-transparent text-white font-semibold shadow-sm border border-gray-600 hover:bg-gray-800 transition-all duration-300 mt-2",
  
  // Background Pattern - Subtle dark pattern
  backgroundPattern: "absolute inset-0 -z-10 opacity-10",
  pattern: "absolute inset-0 bg-[radial-gradient(#3b82f6_1px,transparent_1px)] [background-size:16px_16px]"
};
...
export const signUpPageStyles = {
  // Layout and container styles - Dark theme
  pageContainer: "min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-blue-950 p-4 relative overflow-hidden",
  
  // Back button
  backButton: "absolute top-6 left-6 inline-flex items-center gap-2 text-sm font-medium text-gray-400 hover:text-white z-10 bg-gray-900/80 backdrop-blur-sm px-4 py-2 rounded-xl border border-gray-700 transition-all hover:bg-gray-800 hover:shadow-lg",
  backButtonIcon: "w-5 h-5",
  ...
  // Animation section
  animationContainer: "flex items-center justify-center w-full order-1 md:order-none lg:order-none opacity-80",
  animationWrapper: "w-full flex justify-center",
  
  // Form section
  formContainer: "flex items-center justify-center w-full",
  formWrapper: "relative w-full max-w-md",
  formCard: "relative bg-gray-900/90 backdrop-blur-xl rounded-3xl border border-gray-700 p-8 shadow-2xl transition-all duration-500 hover:border-blue-500/30",
  ...
  // Form
  form: "space-y-2",
  submitButton: "w-full mt-6 py-3 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-full shadow-lg transition-all duration-300 hover:shadow-blue-900/50 disabled:opacity-50 relative overflow-hidden border border-transparent",
  buttonContent: "relative flex items-center justify-center gap-2",
  buttonIcon: "w-5 h-5",
  
  // Sign in link
  signinContainer: "mt-6 text-center",
  signinText: "text-gray-400 text-sm font-[pacifico]",
  signinLink: "text-blue-400 font-semibold hover:text-blue-300"
};

// Floating Input styles - Dark theme
export const floatingInputStyles = {
  container: "relative mb-6 group",
  inputWrapper: "relative",
  input: "w-full bg-gray-800/80 backdrop-blur-sm border-0 rounded-2xl pt-6 pb-4 px-4 text-white placeholder-transparent focus:outline-none focus:ring-2 transition-all duration-300 shadow-inner",
  inputError: "focus:ring-red-500 border-l-4 border-red-500 bg-red-900/20",
  inputNormal: "focus:ring-blue-500 focus:border-l-4 focus:border-blue-500 bg-gray-800/80",
  label: "absolute left-4 transition-all duration-300 cursor-text font-medium",
  labelFocused: "top-2 text-xs text-blue-400",
  labelNormal: "top-5 text-sm text-gray-500",
  labelError: "text-red-400",
  iconsContainer: "absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center gap-2",
  emailIcon: "w-5 h-5 text-gray-500 group-hover:text-blue-400 transition-colors",
  passwordToggle: "focus:outline-none cursor-pointer",
  passwordToggleIcon: "w-5 h-5 text-gray-500 hover:text-blue-400 transition-colors",
  dotsContainer: "absolute -bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-1",
  dot: "w-1 h-1 bg-blue-500 rounded-full animate-bounce",
  errorContainer: "flex items-center mt-2 text-red-400 text-sm ml-1",
  errorIcon: "w-4 h-4 mr-1 text-red-400"
};

// Custom styles for SignUpPage (Unchanged)
export const signUpPageCustomStyles = `
  @keyframes float {
    0%, 100% { transform: translateY(0px); }
    50% { transform: translateY(-15px); }
...
export const testimonialStyles = {
  ...
  section: "py-12 sm:py-16 px-4 sm:px-6 bg-gradient-to-br from-black via-gray-900 to-indigo-950",
  container: "max-w-6xl mx-auto text-center mb-12 sm:mb-16",
  
  // Header
  badge: "inline-flex items-center gap-3 px-4 py-2 rounded-full bg-gray-800/80 backdrop-blur-sm border border-gray-700 mb-4 sm:mb-6",
  badgeDot: "w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full animate-pulse",
  badgeText: "text-sm font-medium text-blue-300",
  title: "text-3xl sm:text-4xl md:text-5xl font-bold font-[Montserrat] mb-3 sm:mb-6",
  titleGradient: "bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400",
  subtitle: "text-base sm:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed",
  ...
  // Testimonial Card
  cardWrapper: "relative group",
  glowBorder: "absolute -inset-2 rounded-3xl bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-indigo-600/20 blur-xl opacity-0 group-hover:opacity-60 transition-all duration-700 pointer-events-none",
  backgroundPattern: "absolute inset-0 rounded-2xl bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm border border-gray-700 pointer-events-none",
  
  // Floating Elements - Darker
  floatingElement1: "absolute -left-4 -top-4 w-16 h-16 rounded-full bg-gradient-to-br from-blue-900/30 to-purple-900/30 blur-xl animate-float-slow pointer-events-none hidden sm:block opacity-50",
  floatingElement2: "absolute -right-6 -bottom-6 w-20 h-20 rounded-full bg-gradient-to-br from-indigo-900/30 to-blue-900/30 blur-xl animate-float pointer-events-none hidden sm:block opacity-50",
  
  // Main Card - Dark theme
  card: "relative z-10 bg-gray-900/80 backdrop-blur-md rounded-2xl p-6 sm:p-8 transform transition-all duration-300 card-init hover:shadow-2xl will-change-transform border border-gray-700 hover:border-blue-500/30 overflow-hidden",
  cardShadow: "0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.05)",
  
  // Course Badge
  courseBadge: "course-badge inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-800/50 border border-gray-700 mb-4 sm:mb-6",
  courseBadgeDot: "w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full",
  courseBadgeText: "text-sm font-medium text-blue-300 truncate",
  
  // Quote Icon
  quoteIcon: "quote-icon absolute top-4 right-4 text-gray-700 transform transition-transform duration-500 hidden sm:block group-hover:text-blue-900/50",
  quoteIconSvg: "w-10 h-10 sm:w-12 sm:h-12",
  
  // Content Layout
  content: "flex items-start gap-4 mb-4 sm:mb-6",
  avatarContainer: "avatar-container relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 flex-shrink-0 transform transition-transform duration-500",
  avatarWrapper: "relative w-full h-full rounded-2xl overflow-hidden border-2 border-gray-700 group-hover:border-blue-500 transition-all",
  avatarImage: "avatar-img w-full h-full object-cover object-center",
  avatarGlow: "absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-600/30 to-purple-600/30 blur-md -z-10 animate-pulse-slow opacity-0 group-hover:opacity-100 transition-opacity",
  
  // User Info
  userInfo: "flex-1 min-w-0",
  userHeader: "flex flex-col md:flex-row items-start md:items-center justify-between mb-2 gap-2",
  userName: "font-[Poppins] font-bold text-white text-base sm:text-lg md:text-lg leading-tight truncate group-hover:text-blue-300 transition-colors",
  userRole: "text-sm sm:text-sm text-blue-400 font-medium truncate",
  ratingContainer: "flex flex-col items-start md:items-end gap-1 mt-2 md:mt-0",
  starsContainer: "flex items-center gap-1 whitespace-nowrap bg-gray-900/50 px-2 py-0.5 rounded-full",
  star: "w-4 h-4",
  starActive: "text-yellow-400 fill-current",
  starInactive: "text-gray-600",
  
  // Message
  message: "text-gray-300 leading-relaxed mb-4 sm:mb-6 relative z-10 text-sm sm:text-base",
  quoteMark: "text-blue-500 font-serif text-xl leading-none",
  
  // Footer
  footer: "flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-800 text-xs sm:text-sm",
  verified: "flex items-center gap-2 text-sm text-gray-400",
  verifiedIcon: "w-4 h-4 text-green-500",
  date: "flex items-center gap-2 text-sm text-gray-400",
  dateIcon: "w-4 h-4 text-blue-500",
...
export const courseDetailStyles = {
  // Layout & Container - Dark theme
  container: "min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-950 py-8 px-4 relative overflow-hidden",
  mainContainer: "max-w-7xl mx-auto space-y-8 relative z-10 transition-all duration-1000",
  containerVisible: "opacity-100 translate-y-0",
  containerHidden: "opacity-0 translate-y-8",
  
  // Back Button
  backButton: "inline-flex cursor-pointer items-center gap-2 px-4 py-2 rounded-xl bg-gray-900/70 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-700 hover:border-gray-500 animate-slideInLeft text-gray-300 hover:text-white",
  backIcon: "w-5 h-5",
  backText: "font-medium",
  
  // Course Header
  header: "text-center space-y-6 relative",
  badge: "inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gray-800/60 backdrop-blur-sm shadow-lg border border-gray-700 animate-bounceIn",
  badgeIcon: "w-5 h-5 text-blue-400",
  badgeText: "text-sm font-medium bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",
  title: "text-4xl md:text-6xl font-[Montserrat] font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 leading-tight animate-fadeInUp",
  
  // Course Overview
  overviewContainer: "max-w-4xl mx-auto",
  overview: "p-6 font-serif rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500 animate-slideInUp",
  overviewHeader: "flex items-center gap-3 mb-3",
  overviewIcon: "w-5 h-5 text-blue-400",
  overviewTitle: "text-lg font-semibold text-white",
  overviewText: "text-gray-300 text-base leading-relaxed text-left",
  
  // Course Stats
  statsContainer: "flex items-center justify-center gap-8 flex-wrap animate-fadeInUp",
  statItem: "flex items-center gap-3 text-gray-300 bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700",
  statIcon: "w-5 h-5 text-blue-400",
  statText: "font-medium",
  teacherStat: "flex items-center gap-3 text-gray-300 bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700 transition-all duration-1000 group hover:border-blue-500",
  teacherAnimating: "scale-110 bg-blue-900/30 border-blue-500",
  ...
  // Video Player
  videoSection: "xl:col-span-2 space-y-6",
  videoContainer: "rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-2xl overflow-hidden border border-gray-700 hover:border-blue-500/50 transition-all duration-500 animate-slideInRight",
  video: "w-full h-[500px] object-cover bg-black rounded-t-3xl",
  iframe: "w-full h-[500px] rounded-t-3xl",
  videoPlaceholder: "w-full h-[500px] flex items-center justify-center bg-gradient-to-br from-gray-950 to-black text-white relative overflow-hidden rounded-t-3xl",
  videoPlaceholderBg: "absolute inset-0 opacity-20 bg-[url('/grid-pattern.svg')]",
  videoPlaceholderOrb1: "absolute top-1/4 left-1/4 w-32 h-32 bg-purple-900/50 rounded-full mix-blend-overlay filter blur-xl",
  videoPlaceholderOrb2: "absolute bottom-1/4 right-1/4 w-32 h-32 bg-blue-900/50 rounded-full mix-blend-overlay filter blur-xl",
  videoPlaceholderContent: "text-center relative z-10",
  videoPlaceholderIcon: "w-20 h-20 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform",
  videoPlaceholderPlayIcon: "w-8 h-8 opacity-70 text-white",
  videoPlaceholderText: "text-xl mb-2 font-bold",
  videoPlaceholderSubtext: "text-lg text-gray-400",
  
  // Video Info
  videoInfo: "p-6",
  videoTitle: "text-2xl font-bold text-white mb-3",
  videoDescription: "text-gray-400 leading-relaxed",
  videoMeta: "flex items-center gap-3 mt-4",
  durationBadge: "flex items-center gap-2 text-gray-300 bg-gray-800/50 px-3 py-1 rounded-full border border-gray-700",
  durationIcon: "w-4 h-4 text-blue-400",
  chapterBadge: "text-sm bg-blue-900/30 text-blue-300 px-3 py-1 rounded-full border border-blue-800/50",
  
  // Completion Button
  completionSection: "mt-6 pt-6 border-t border-gray-800",
  completionButton: "inline-flex cursor-pointer items-center gap-3 px-6 py-3 rounded-2xl font-semibold transition-all duration-300 backdrop-blur-sm shadow-md",
  completionButtonCompleted: "bg-green-900/20 text-green-400 hover:bg-green-900/30 border border-green-800/50 hover:border-green-700/50",
  completionButtonIncomplete: "bg-blue-900/20 text-blue-400 hover:bg-blue-900/30 border border-blue-800/50 hover:border-blue-700/50",
  completionIcon: "w-5 h-5",
  completionText: "text-sm text-gray-500 mt-2",
  ...
  // Course Content
  contentCard: "p-6 rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500 animate-slideInLeft",
  contentHeader: "flex items-center justify-between mb-6",
  contentTitle: "text-xl font-bold text-white",
  freeBadge: "text-sm text-green-400 font-semibold bg-green-900/30 px-3 py-1 rounded-full flex items-center gap-2 border border-green-800/50",
  freeBadgeIcon: "w-4 h-4",
  contentList: "space-y-3 max-h-[600px] overflow-y-auto custom-scrollbar",
  
  // Lecture Item
  lectureItem: "rounded-2xl bg-gray-800/50 backdrop-blur-sm shadow-lg border border-gray-700 hover:border-blue-500/50 transition-all duration-300 animate-fadeInUp overflow-hidden",
  lectureHeader: "p-4 cursor-pointer transition-all duration-300",
  lectureHeaderExpanded: "bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-b border-gray-700",
  lectureHeaderCollapsed: "hover:bg-gray-800/70",
  lectureHeaderContent: "flex items-center justify-between",
  lectureLeftSection: "flex items-center gap-3",
  lectureChevron: "transform transition-transform duration-300",
  lectureChevronExpanded: "rotate-180 text-blue-400",
  lectureChevronCollapsed: "text-gray-500",
  lectureInfo: "",
  lectureTitle: "font-semibold text-white",
  lectureMeta: "text-sm text-gray-400 flex items-center gap-3 mt-1",
  lectureDuration: "flex items-center gap-1",
  lectureChapterCount: "text-xs bg-gray-900/50 px-2 py-1 rounded-full border border-gray-800",
  
  // Chapter List
  chapterList: "p-4 pt-0 space-y-2 animate-fadeIn bg-gray-900/30",
  chapterItem: "p-3 rounded-xl cursor-pointer transition-all duration-300 group",
  chapterSelected: "bg-gradient-to-r from-blue-900/40 to-purple-900/40 border-2 border-blue-500/50 shadow-md",
  chapterNotSelected: "bg-gray-800/30 hover:bg-gray-800/50 border border-transparent hover:border-gray-700",
  chapterDisabled: "opacity-50 cursor-not-allowed",
  chapterContent: "flex items-center justify-between",
  chapterLeftSection: "flex items-center gap-3 flex-1",
  completionToggle: "flex-shrink-0 transition-all duration-300 hover:scale-110",
  completionToggleCompleted: "text-green-500",
  completionToggleIncomplete: "text-gray-600 group-hover:text-gray-400",
  completionIconSmall: "w-5 h-5",
  chapterText: "flex-1",
  chapterName: "font-medium transition-colors duration-300",
  chapterNameSelected: "text-blue-300",
  chapterNameNotSelected: "text-gray-300 group-hover:text-white",
  chapterTopic: "text-sm text-gray-500",
  chapterDuration: "text-sm text-gray-400 bg-gray-900/50 px-2 py-1 rounded-full border border-gray-800",
  
  // Pricing Card
  pricingCard: "p-6 rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500 animate-slideInLeft",
  pricingHeader: "flex items-center gap-2 mb-4",
  pricingTitle: "font-bold text-lg text-white",
  pricingAmount: "flex items-baseline gap-3 mb-2",
  price: "text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",
  originalPrice: "text-sm text-gray-500 line-through",
  discountBadge: "ml-auto text-sm bg-gradient-to-r from-green-900/30 to-emerald-900/30 text-green-400 px-3 py-1 rounded-full border border-green-800/50",
  pricingDescription: "text-sm text-gray-400 mb-6",
  
  // Enrollment Buttons
  enrollButton: "w-full inline-flex items-center justify-center gap-3 px-6 py-4 rounded-full cursor-pointer font-semibold shadow-lg hover:shadow-blue-900/50 transform transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed border border-transparent",
  freeEnrolledButton: "bg-gradient-to-r from-green-600 to-emerald-600 text-white cursor-default shadow-green-900/30",
  enrollPaidButton: "bg-gradient-to-r from-blue-600 to-purple-600 text-white",
  enrolledButton: "bg-transparent border-green-500 text-green-400 shadow-sm cursor-default hover:bg-green-900/10",
  enrollSpinner: "w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin",
  enrollIcon: "w-5 h-5 transition-transform",
  enrollArrow: "ml-auto opacity-80 group-hover:opacity-100 translate-x-0 group-hover:translate-x-1 transition-transform",
  
  // Progress Card
  progressCard: "p-6 rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500 animate-slideInLeft",
  progressHeader: "flex items-center gap-2 mb-4",
  progressIcon: "w-5 h-5 text-blue-400",
  progressTitle: "font-semibold text-white",
  progressContent: "space-y-4",
  progressBar: "w-full bg-gray-800/50 rounded-full h-3 backdrop-blur-sm overflow-hidden",
  progressFill: "bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full transition-all duration-1000 ease-out shadow-lg shadow-blue-900/50",
  progressStats: "grid grid-cols-2 gap-4 text-center",
  progressStat: "p-4 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 hover:bg-gray-800/70 transition-all duration-300 group hover:border-blue-500/30",
  progressStatValue: "text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",
  progressStatLabel: "text-sm text-gray-400 mt-1 group-hover:text-gray-300",
  ...
  toastError: "bg-red-900/90 text-white",
  toastInfo: "bg-blue-900/90 text-white",
  toastContent: "flex items-center gap-3",
  toastClose: "hover:scale-110 transition-transform text-white/70 hover:text-white",
  toastCloseIcon: "w-4 h-4",
  
  // Not Found State
  notFoundContainer: "min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-black via-gray-900 to-blue-950 relative overflow-hidden",
  notFoundContent: "text-center relative z-10 p-8 rounded-3xl bg-gray-900/50 backdrop-blur-md border border-gray-800",
  notFoundTitle: "text-2xl font-bold text-white",
  notFoundText: "mt-2 text-gray-400",
  notFoundButton: "mt-4 cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-lg shadow-lg bg-blue-600 hover:bg-blue-700 text-white transition-all",
...
export const courseDetailStylesH = {
  // Layout and container styles - Dark theme
  pageContainer: "min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-950 py-8 px-4 relative overflow-x-hidden",
  mainContainer: "max-w-7xl mx-auto space-y-8 relative z-10 transition-all duration-1000",
  ...
  // Course header
  headerContainer: "text-center space-y-6 relative",
  courseBadge: "inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gray-800/60 backdrop-blur-sm shadow-lg border border-gray-700 animate-bounceIn",
  badgeIcon: "w-5 h-5 text-blue-400",
  badgeText: "text-sm font-medium bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",
  courseTitle: "text-3xl sm:text-4xl md:text-6xl font-[Montserrat] font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 leading-tight animate-fadeInUp",
  
  // Overview section
  overviewContainer: "max-w-4xl mx-auto",
  overviewCard: "p-6 font-serif rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500 animate-slideInUp",
  overviewHeader: "flex items-center gap-3 mb-3",
  overviewIcon: "w-5 h-5 text-blue-400",
  overviewTitle: "text-lg font-semibold text-white",
  overviewText: "text-gray-300 text-base leading-relaxed text-left",
  ...
  statText: "font-medium",
  teacherStat: "flex items-center gap-3 text-gray-300 bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700 transition-all duration-1000 group hover:border-blue-500",
  teacherIcon: "w-5 h-5 text-blue-400",
  teacherText: "font-medium font-[pacifico] group-hover:text-blue-300",
  ...
  videoWrapper: "w-full bg-black relative",
  videoFrame: "w-full h-[220px] sm:h-[320px] md:h-[420px] lg:h-[500px] rounded-t-3xl",
  videoPlaceholder: "w-full h-[220px] sm:h-[320px] md:h-[420px] lg:h-[500px] flex items-center justify-center bg-gradient-to-br from-gray-950 to-black text-white relative overflow-hidden rounded-t-3xl",
  videoPlaceholderPattern: "absolute inset-0 opacity-20 bg-[url('/grid-pattern.svg')]",
  videoPlaceholderBlob: "absolute w-32 h-32 rounded-full mix-blend-overlay filter blur-xl bg-blue-900/30",
  videoPlaceholderContent: "text-center relative z-10 px-4",
  videoPlaceholderIcon: "w-20 h-20 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform",
  videoPlaceholderPlayIcon: "w-8 h-8 opacity-70 text-white",
  videoPlaceholderText: "text-xl mb-2 font-bold",
  ...
  // Completion button
  completionSection: "mt-6 pt-6 border-t border-gray-800",
  completionButton: "inline-flex cursor-pointer items-center gap-3 px-6 py-3 rounded-2xl font-semibold transition-all duration-300 backdrop-blur-sm shadow-md hover:scale-105",
  completionButtonCompleted: "bg-green-900/20 text-green-400 hover:bg-green-900/30 border border-green-800/50 hover:border-green-700/50",
  completionButtonIncomplete: "bg-blue-900/20 text-blue-400 hover:bg-blue-900/30 border border-blue-800/50 hover:border-blue-700/50",
  completionIcon: "w-5 h-5",
  completionText: "text-sm text-gray-500 mt-2",
  ...
  // Sidebar sections
  sidebar: "space-y-6",
  sidebarCard: "p-6 rounded-3xl bg-gray-900/80 backdrop-blur-md shadow-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-500",
  
  // Course content
  contentHeader: "flex items-center justify-between mb-6",
  contentTitle: "text-xl font-bold text-white",
  freeAccessBadge: "text-sm text-green-400 font-semibold bg-green-900/30 px-3 py-1 rounded-full flex items-center gap-2 border border-green-800/50",
  freeAccessIcon: "w-4 h-4",
  contentList: "space-y-3 max-h-[320px] sm:max-h-[420px] md:max-h-[600px] overflow-y-auto custom-scrollbar",
  ...
  lectureHeader: "p-4 cursor-pointer transition-all duration-300",
  lectureHeaderExpanded: "bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-b border-gray-700",
  lectureHeaderNormal: "hover:bg-gray-800/70",
  lectureContent: "flex items-center justify-between",
  lectureLeft: "flex items-center gap-3",
  lectureChevron: "transform transition-transform duration-300",
  lectureChevronExpanded: "rotate-180 text-blue-400",
  ...
  lectureDuration: "flex items-center gap-1",
  lectureDurationIcon: "w-4 h-4",
  lectureChaptersCount: "text-xs bg-gray-900/50 px-2 py-1 rounded-full border border-gray-800",
  
  // Chapters list
  chaptersList: "p-4 pt-0 space-y-2 animate-fadeIn bg-gray-900/30",
  chapterItem: "p-3 rounded-xl cursor-pointer transition-all duration-300 group",
  chapterItemSelected: "bg-gradient-to-r from-blue-900/40 to-purple-900/40 border-2 border-blue-500/50 shadow-md",
  chapterItemNormal: "bg-gray-800/30 hover:bg-gray-800/50 border border-transparent hover:border-gray-700",
  chapterContent: "flex items-center justify-between",
  chapterLeft: "flex items-center gap-3 flex-1",
  chapterCompletionButton: "flex-shrink-0 transition-all duration-300 hover:scale-110",
  chapterCompletionCompleted: "text-green-500",
  chapterCompletionNormal: "text-gray-600 group-hover:text-gray-400",
  chapterInfo: "flex-1",
  chapterName: "font-medium transition-colors duration-300",
  chapterNameSelected: "text-blue-300",
  chapterNameNormal: "text-gray-300 group-hover:text-white",
  chapterTopic: "text-sm text-gray-500",
  chapterDuration: "text-sm text-gray-400 bg-gray-900/50 px-2 py-1 rounded-full border border-gray-800",
  ...
  pricingTitle: "font-bold text-lg text-white",
  pricingAmount: "flex items-baseline gap-3 mb-2",
  pricingCurrent: "text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",
  pricingOriginal: "text-sm text-gray-500 line-through",
  pricingDiscount: "ml-auto text-sm bg-gradient-to-r from-green-900/30 to-emerald-900/30 text-green-400 px-3 py-1 rounded-full border border-green-800/50",
  pricingDescription: "text-sm text-gray-400 mb-6",
  
  // Enroll button
  enrollButton: "w-full inline-flex cursor-pointer items-center justify-center gap-3 px-6 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold shadow-lg hover:shadow-blue-900/50 transform transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed border border-transparent",
  enrollButtonFree: "w-full inline-flex items-center justify-center gap-3 px-6 py-2 sm:py-4 md:py-4 lg:py-4 xl:py-4 rounded-full bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold shadow-sm cursor-default group shadow-green-900/30",
  enrollButtonEnrolled: "w-full inline-flex items-center justify-center gap-3 px-6 py-4 rounded-full bg-transparent border border-green-500 text-green-400 font-semibold shadow-sm cursor-default group hover:bg-green-900/10",
  enrollButtonIcon: "w-5 h-5 transition-transform",
  enrollSpinner: "w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin",
  ...
  progressTitle: "font-semibold text-white",
  progressSection: "space-y-4",
  progressBarContainer: "w-full bg-gray-800/50 rounded-full h-3 backdrop-blur-sm overflow-hidden",
  progressBar: "bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full transition-all duration-1000 ease-out shadow-lg shadow-blue-900/50",
  progressStats: "grid grid-cols-2 gap-4 text-center",
  progressStat: "p-4 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 hover:bg-gray-800/70 transition-all duration-300 group hover:border-blue-500/30",
  progressStatValue: "text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",
  progressStatLabel: "text-sm text-gray-400 mt-1 group-hover:text-gray-300",
  ...
  // Not found page
  notFoundContainer: "min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-black via-gray-900 to-blue-950 relative overflow-hidden",
  notFoundPattern: "absolute inset-0 opacity-10 bg-[url('/grid-pattern.svg')]",
  notFoundBlob: "absolute w-72 h-72 rounded-full mix-blend-overlay filter blur-xl animate-blob bg-blue-900/30",
  notFoundContent: "text-center relative z-10 p-8 rounded-3xl bg-gray-900/50 backdrop-blur-md border border-gray-800",
  notFoundTitle: "text-2xl font-bold text-white",
  notFoundText: "mt-2 text-gray-400",
  notFoundButton: "mt-4 cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-lg shadow-lg bg-blue-600 hover:bg-blue-700 text-white transition-all"
...
// Toast styles (Unchanged, already dark compatible)
export const toastStyles = {
  toast: "fixed top-6 right-6 p-4 rounded-2xl shadow-2xl backdrop-blur-md transform transition-all duration-500 z-50 animate-slideInRight border border-white/10",
  toastError: "bg-red-900/90 text-white",
  toastInfo: "bg-blue-900/90 text-white",
...
// Custom styles for CourseDetail (Unchanged)
export const courseDetailCustomStyles = `
  @keyframes fadeIn {
    from { opacity: 0; transform: translateY(-10px); }
    to { opacity: 1; transform: translateY(0); }
...
export const loginPageStyles = {
  // Layout and container styles - Dark theme
  pageContainer: "min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-950 relative overflow-hidden",
  
  // Back button
  backButton: "absolute top-6 left-6 z-10 group",
  backButtonContainer: "flex items-center space-x-2 text-gray-400 hover:text-white transition-all duration-300 transform hover:translate-x-1",
  backButtonIcon: "p-2 bg-gray-900/70 rounded-full backdrop-blur-sm group-hover:bg-gray-800/90 transition-all duration-300 shadow-sm border border-gray-700",
  backButtonArrow: "w-5 h-5",
  backButtonText: "font-semibold",
  ...
  // Animation section
  animationContainer: "flex flex-1 items-center justify-center w-full mb-8 lg:mb-0 opacity-80",
  
  // Login card
  cardContainer: "flex-1 flex justify-center w-full",
  cardWrapper: "relative w-full max-w-md",
  cardGlow: "absolute -inset-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-2xl blur-lg opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200",
  mainCard: "relative bg-gray-900/90 backdrop-blur-xl rounded-2xl border border-gray-700 shadow-2xl transform transition-all duration-500 hover:border-blue-500/30",
  cardTopLine: "absolute -top-1 left-8 right-8 h-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-t-2xl blur-sm opacity-70",
  cardContent: "p-8",
  
  // Header
  header: "text-center mb-8",
  title: "text-4xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent mb-2 transform hover:scale-110 transition-transform duration-300",
  subtitle: "text-gray-400",
  
  // Form
  form: "space-y-6",
  formGroup: "group",
  label: "flex items-center space-x-3 text-gray-300 mb-2",
  labelIcon: "w-5 h-5 text-blue-400",
  inputContainer: "relative",
  input: "w-full px-4 py-3 pl-12 bg-gray-800/60 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 focus:bg-gray-800/80 focus:ring-2 focus:ring-cyan-900/50 transition-all duration-300 backdrop-blur-sm",
  passwordInput: "w-full px-4 py-3 pl-12 pr-12 bg-gray-800/60 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-400 focus:bg-gray-800/80 focus:ring-2 focus:ring-purple-900/50 transition-all duration-300 backdrop-blur-sm",
  inputIcon: "absolute left-4 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-500 group-hover:text-blue-400 transition-colors",
  passwordToggle: "absolute right-4 cursor-pointer top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-blue-400 transition-colors duration-200",
  passwordToggleIcon: "w-4 h-4",
  
  // Submit button
  submitButton: "w-full py-4 px-6 bg-gradient-to-br from-cyan-500 to-blue-600 text-white font-semibold rounded-full cursor-pointer hover:shadow-lg hover:shadow-cyan-900/30 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-cyan-900/30 relative overflow-hidden group shadow-md border border-transparent",
  buttonContent: "flex items-center justify-center space-x-2",
  buttonIcon: "w-5 h-5 text-white",
  buttonText: "relative text-white z-10",
  
  // Sign up link
  signupContainer: "text-center mt-6 relative z-10",
  signupText: "text-gray-400",
  signupLink: "text-cyan-400 hover:text-cyan-300 font-semibold transition-colors duration-200",
  
  // Toast notification
  toast: "fixed bottom-6 right-6 bg-gray-900/90 backdrop-blur-xl border border-green-900 shadow-2xl rounded-xl px-6 py-2 flex items-center space-x-3 animate-fade-in-up",
  toastIcon: "text-green-400 w-6 h-6",
  toastContent: "",
  toastTitle: "font-semibold text-green-400",
  toastMessage: "text-sm text-gray-400"
};

// Icon colors (Unchanged, already suitable)
export const loginIconColors = {
  cyan: "text-cyan-400",
  purple: "text-purple-400",
  cyan600: "text-cyan-500",
  purple600: "text-purple-500"
};

// Custom styles for LoginPage (Unchanged)
export const loginPageCustomStyles = `
  @keyframes fade-in-up {
    0% { opacity: 0; transform: translateY(20px); }
    100% { opacity: 1; transform: translateY(0); }
